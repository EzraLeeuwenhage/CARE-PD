...
def main_world2cam2img_custom_cm(cfg, view):
    ...
    # Adapted: Dynamically generate filenames based on input file
    base_name = cfg.DATA_DIR.stem
    cfg.OUT_PATH_world = cfg.OUT_PATH / f'{base_name}__2_h36m_{view}_world{ext}.npz'
    cfg.OUT_PATH_cam = cfg.OUT_PATH / f'{base_name}__2_h36m_{view}_cam{ext}.npz'
    cfg.OUT_PATH_image = cfg.OUT_PATH / f'{base_name}__2_h36m_{view}_image{ext}.npz'
...
if __name__ == "__main__":
    test_input_filename = "thesis/data/processed/PD-GaM/SMPL/example_generated_prior.pkl"
    convert_smpl_to_h36m(input_filename=test_input_filename)